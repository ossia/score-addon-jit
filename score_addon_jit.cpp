...
score_addon_jit::score_addon_jit()
{
  ...
  int argc = 0;
  char** argv = nullptr;
  sys::PrintStackTraceOnErrorSignal("/usr/bin/false");
...
{
    return instantiate_factories<  >(ctx, key);
}
